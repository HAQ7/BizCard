...
function AuthPage() {
  ...
  const [authType, setAuthType] = useState(authTypeParam === "signup" ? "signup" : "login");
  ...
  const validateAllFields = () => {
    ...
    const requiredFields = authType === "login" 
      ? ["username", "password"]
      : ["fullName", "roleName", "phoneNumber", "username", "email", "password", "confirmpassword"];
        ...
        <div className="mt-10 max-w-[500px] w-full">
          <div className="flex justify-around w-full">
            <div>
              <button
                className={`text-2xl font-semibold cursor-pointer ${
                  authType === "login" ? "text-black" : "text-[#A0A0A0]"
                }`}
            ...
            <div>
              <button
                className={`text-2xl font-semibold cursor-pointer ${
                  authType === "signup" ? "text-black" : "text-[#A0A0A0]"
                }`}
          ...
          <form className="bg-white shadow p-5 mt-3 rounded-xl" onSubmit={handleSubmit}>
              ...
              {authType === "login" ? (
                <>
                  <div className="relative">
                    ...
                    />
                    <label className={`absolute left-2 transition-all duration-200 pointer-events-none ${
                      isFieldActive("username") 
                        ? `top-1 text-xs ${hasError("username") ? "text-red-500" : "text-[#0051FF]"}` 
                  ...
                  <div className="relative">
                    ...
                    <label className={`absolute left-2 transition-all duration-200 pointer-events-none ${
                      isFieldActive("password") 
                        ? `top-1 text-xs ${hasError("password") ? "text-red-500" : "text-[#0051FF]"}` 
                        : "top-2 text-base text-gray-500"
                    }`}>
                      Password
                    </label>
                ...
                <>
                    ...
                    <div className="relative">
                      ...
                      <label className={`absolute left-2 transition-all duration-200 pointer-events-none ${
                        isFieldActive("fullName") 
                          ? `top-1 text-xs ${hasError("fullName") ? "text-red-500" : "text-[#0051FF]"}` 
                          : "top-2 text-base text-gray-500"
                      }`}>
                        Full name
                      </label>
                    ...
                    <div className="relative">
                      ...
                      <label className={`absolute left-2 transition-all duration-200 pointer-events-none ${
                        isFieldActive("roleName") 
                          ? `top-1 text-xs ${hasError("roleName") ? "text-red-500" : "text-[#0051FF]"}` 
                          : "top-2 text-base text-gray-500"
                      }`}>
                        Role name
                      </label>
                  ...
                  <div className="relative">
                    ...
                    <label className={`absolute left-2 transition-all duration-200 pointer-events-none ${
                      isFieldActive("phoneNumber") 
                        ? `top-1 text-xs ${hasError("phoneNumber") ? "text-red-500" : "text-[#0051FF]"}` 
                        : "top-2 text-base text-gray-500"
                    }`}>
                      Phone number
                    </label>
                  ...
                  <div className="relative">
                    ...
                    <label className={`absolute left-2 transition-all duration-200 pointer-events-none ${
                      isFieldActive("email") 
                        ? `top-1 text-xs ${hasError("email") ? "text-red-500" : "text-[#0051FF]"}` 
                        : "top-2 text-base text-gray-500"
                    }`}>
                      Email
                    </label>
                  ...
                  <div className="relative">
                    ...
                    <label className={`absolute left-2 transition-all duration-200 pointer-events-none ${
                      isFieldActive("confirmpassword") 
                        ? `top-1 text-xs ${hasError("confirmpassword") ? "text-red-500" : "text-[#0051FF]"}` 
                        : "top-2 text-base text-gray-500"
                    }`}>
                      Confirm Password
                    </label>
